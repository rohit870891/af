...
main_buttons = [[
        InlineKeyboardButton('Main Channel', url='https://t.me/roger_pro')
        ],[
        InlineKeyboardButton('📜 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ', url='https://t.me/NovaBotsNF'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ  ', url='https://t.me/Codeflix_Bots')
        ],[
